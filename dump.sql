...
CREATE TABLE `module_enseignant` (
  ...
  CONSTRAINT `module_enseignant_ibfk_5` FOREIGN KEY (`ID_module`) REFERENCES `module` (`ID_module`),
  CONSTRAINT `module_enseignant_ibfk_6` FOREIGN KEY (`Matricule`) REFERENCES `user` (`Matricule`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `module_enseignant` VALUES (26,2006,'Cour',NULL),(27,2002,'Cour',NULL),(28,2005,'Cour',NULL),(29,2003,'Cour',NULL),(30,2007,'Cour',NULL),(32,2010,'Cour',NULL),(33,2009,'Cour',NULL),(47,2004,'Cour',NULL);
...
-- Dump completed on 2025-05-10  1:50:15
