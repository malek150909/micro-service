  ...
  return (
    <>
      ...
      >
        ...
        <table className="ADM-EXM-exam-table">
          <thead>
            <tr>
              <th>Date</th>
              <th>Horaire</th>
          ...
          >
            ...
            {(!modules || modules.length === 0) ? (
              ...
              <form onSubmit={handleUpdate}>
                ...
                <div className="ADM-EXM-modal-field">
                  <label>Horaire</label>
                  <select name="time_slot" value={editExam?.time_slot || ''} onChange={handleChange} required className="ADM-EXM-select">
                ...
                <div className="ADM-EXM-modal-field">
                  <label>Mode</label>
                  <select name="mode" value={editExam?.mode || ''} onChange={handleChange} required className="ADM-EXM-select">
                ...
                <div className="ADM-EXM-modal-field">
                  ...
                  <div className={`ADM-EXM-custom-dropdown ${isSalleDropdownOpen ? 'ADM-EXM-open' : ''}`}>
                    ...
                    <div className={`ADM-EXM-dropdown-menu ${isSalleDropdownOpen && editExam?.mode === 'presentiel' ? 'ADM-EXM-dropdown-visible' : ''}`}>
                      {availableSalles.map((salle) => (
                        <label key={salle.ID_salle} className="ADM-EXM-checkbox-label">
                          <input
                            type="checkbox"
