...
const ResourceUploadForm = ({
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        ...
        const response = await fetch('http://courses.localhost/ressources/sections', {
          headers: {
  ...
  const fetchModules = async (sectionId) => {
    try {
      ...
      const response = await fetch(`http://courses.localhost/ressources/modules/${sectionId}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'matricule': matricule
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://courses.localhost/ressources/upload', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'matricule': matricule
