...
function Calendar() {
  ...
  const fetchEvents = async (startDate, endDate) => {
    try {
      ...
      allEvents.forEach((event) => {
        console.log(`Événement: ${event.title}, Type: ${event.type}, ID: ${event.ID_event || event.ID_seance_supp || event.ID_club_evenement}, Date: ${event.date}, Time_slot: ${event.time_slot}`)
      })
      setEvents(allEvents)
    } catch (error) {
  ...
  const handleDateClick = (date) => {
    console.log("handleDateClick called with date:", date, "Type:", typeof date)
    ...
    console.log("After handleDateClick, selectedDate:", date, "viewMode:", "daily")
  }
