...
INSERT INTO `admin` VALUES (909,'Doyen'),(1509,'President');
...
INSERT INTO `annonce` VALUES (41,'test','Nouveau événement : test - Date : 2025-06-15 12:00:00 - Lieu : salle de conference Faculte Info','',44,'2025-05-14 12:11:06','Etudiants','{\"tous\": true, \"faculte\": \"\", \"specialite\": \"\", \"departement\": \"\"}',NULL,909);
...
INSERT INTO `enseignant` VALUES (2001,'2010-09-01',7,21),(2002,'2025-03-23',7,22),(2003,'2025-03-23',7,22),(2004,'2025-03-23',7,22),(2005,'2025-03-23',7,22),(2006,'2025-03-23',7,22),(2007,'2025-03-23',7,22),(2008,'2025-03-23',7,22),(2009,'2025-03-23',7,22),(2010,'2025-03-23',7,22),(2011,'2025-05-13',7,22),(2012,'2025-05-13',7,22),(2013,'2025-05-13',7,22),(2014,'2025-05-13',7,22);
...
INSERT INTO `enseignant_section` VALUES (2001,6),(2002,6),(2003,6),(2004,6),(2005,6),(2006,6),(2007,6),(2009,6),(2010,6),(2011,6),(2012,6),(2013,6),(2014,6);
...
INSERT INTO `etudiant` VALUES (212131095493,15,'2024-09-15','Admis','L3',4),(212231446507,15,'2025-04-27','Admis','L3',2),(222231657517,15,'2024-09-15','Admis','L3',2);
...
INSERT INTO `etudiant_section` VALUES (212131095493,6),(212231446507,6),(222231657517,6);
...
INSERT INTO `evenement` VALUES (44,'test','test','2025-06-15','salle de conference Faculte Info',200,NULL,909,'12:00:00','Etudiants');
...
INSERT INTO `module_enseignant` VALUES (27,2002,'Cour/TP'),(29,2003,'Cour/TD'),(47,2004,'Cour/TD'),(28,2005,'Cour/TD'),(26,2006,'Cour/TD'),(30,2007,'enligne'),(33,2009,'Cour'),(32,2010,'Cour'),(27,2011,'TD'),(26,2012,'TP'),(47,2013,'TP'),(47,2014,'TP');
/*!40000 ALTER TABLE `module_enseignant` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `module_enseignant_groupe`
--

DROP TABLE IF EXISTS `module_enseignant_groupe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `module_enseignant_groupe` (
  ...
  PRIMARY KEY (`ID_module`,`Matricule`,`course_type`,`ID_groupe`),
  KEY `Matricule` (`Matricule`),
  KEY `ID_groupe` (`ID_groupe`),
  CONSTRAINT `module_enseignant_groupe_ibfk_1` FOREIGN KEY (`ID_module`) REFERENCES `module` (`ID_module`),
  CONSTRAINT `module_enseignant_groupe_ibfk_2` FOREIGN KEY (`Matricule`) REFERENCES `user` (`Matricule`),
  CONSTRAINT `module_enseignant_groupe_ibfk_3` FOREIGN KEY (`ID_groupe`) REFERENCES `groupe` (`ID_groupe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `module_enseignant_groupe`
--

LOCK TABLES `module_enseignant_groupe` WRITE;
/*!40000 ALTER TABLE `module_enseignant_groupe` DISABLE KEYS */;
INSERT INTO `module_enseignant_groupe` VALUES (26,2006,'TD',2),(26,2012,'TP',2),(27,2002,'TP',2),(27,2011,'TD',2),(28,2005,'TD',2),(29,2003,'TD',2),(47,2004,'TD',2),(47,2013,'TP',2),(26,2006,'TD',3),(26,2012,'TP',3),(27,2002,'TP',3),(27,2011,'TD',3),(28,2005,'TD',3),(29,2003,'TD',3),(47,2004,'TD',3),(47,2014,'TP',3),(26,2006,'TD',4),(26,2012,'TP',4),(27,2002,'TP',4),(27,2011,'TD',4),(28,2005,'TD',4),(29,2003,'TD',4),(47,2004,'TD',4),(47,2013,'TP',4),(26,2006,'TD',5),(26,2012,'TP',5),(27,2002,'TP',5),(27,2011,'TD',5),(28,2005,'TD',5),(29,2003,'TD',5),(47,2004,'TD',5),(47,2013,'TP',5);
/*!40000 ALTER TABLE `module_enseignant_groupe` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `module_etudiant` VALUES (7,212131095493,'S1',10.77,'bien');
...
INSERT INTO `seance` VALUES (1759,9,2006,'TD',2,26,'Lundi','08:00 - 09:30',6),(1760,9,2006,'TD',3,26,'Lundi','09:40 - 11:10',6),(1761,9,2006,'TD',4,26,'Lundi','14:40 - 16:10',6),(1762,9,2006,'TD',5,26,'Lundi','16:20 - 17:50',6),(1763,55,2012,'TP',2,26,'Lundi','09:40 - 11:10',6),(1764,55,2012,'TP',3,26,'Lundi','08:00 - 09:30',6),(1765,55,2012,'TP',4,26,'Lundi','16:20 - 17:50',6),(1766,55,2012,'TP',5,26,'Lundi','14:40 - 16:10',6),(1767,16,2011,'TD',2,27,'Lundi','14:40 - 16:10',6),(1768,16,2011,'TD',3,27,'Lundi','16:20 - 17:50',6),(1769,16,2011,'TD',4,27,'Lundi','08:00 - 09:30',6),(1770,16,2011,'TD',5,27,'Lundi','09:40 - 11:10',6),(1771,55,2002,'TP',2,27,'Mardi','08:00 - 09:30',6),(1772,55,2002,'TP',3,27,'Mardi','09:40 - 11:10',6),(1773,55,2002,'TP',4,27,'Mardi','14:40 - 16:10',6),(1774,55,2002,'TP',5,27,'Mardi','16:20 - 17:50',6),(1775,9,2005,'TD',2,28,'Mardi','09:40 - 11:10',6),(1776,9,2005,'TD',3,28,'Mardi','08:00 - 09:30',6),(1777,9,2005,'TD',4,28,'Mardi','16:20 - 17:50',6),(1778,9,2005,'TD',5,28,'Mardi','14:40 - 16:10',6),(1779,16,2003,'TD',2,29,'Mardi','14:40 - 16:10',6),(1780,16,2003,'TD',3,29,'Mardi','16:20 - 17:50',6),(1781,16,2003,'TD',4,29,'Mardi','08:00 - 09:30',6),(1782,16,2003,'TD',5,29,'Mardi','09:40 - 11:10',6),(1783,9,2004,'TD',2,47,'Mercredi','08:00 - 09:30',6),(1784,9,2004,'TD',3,47,'Mercredi','09:40 - 11:10',6),(1785,9,2004,'TD',4,47,'Mercredi','14:40 - 16:10',6),(1786,9,2004,'TD',5,47,'Mercredi','16:20 - 17:50',6),(1787,55,2013,'TP',2,47,'Mercredi','09:40 - 11:10',6),(1788,55,2014,'TP',3,47,'Mercredi','08:00 - 09:30',6),(1789,56,2013,'TP',4,47,'Mercredi','08:00 - 09:30',6),(1790,55,2013,'TP',5,47,'Mercredi','14:40 - 16:10',6),(1791,15,2006,'cours',NULL,26,'Lundi','11:20 - 12:50',6),(1792,15,2002,'cours',NULL,27,'Mardi','11:20 - 12:50',6),(1793,15,2005,'cours',NULL,28,'Mercredi','11:20 - 12:50',6),(1794,15,2003,'cours',NULL,29,'Jeudi','08:00 - 09:30',6),(1795,15,2004,'cours',NULL,47,'Jeudi','09:40 - 11:10',6);
...
--
-- Table structure for table `student_grades_archive`
--

DROP TABLE IF EXISTS `student_grades_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `student_grades_archive`
--

LOCK TABLES `student_grades_archive` WRITE;
/*!40000 ALTER TABLE `student_grades_archive` DISABLE KEYS */;
/*!40000 ALTER TABLE `student_grades_archive` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-14 18:57:45
